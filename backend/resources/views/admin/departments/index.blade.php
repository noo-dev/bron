        ...
        <div class="col-12">
            <div class="card">
              <div class="card-header">
                ...
                <a href="{{ route('room-types.create') }}" class="float-right btn btn-success">Täze bölüm goşmak</a>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                            ...
                            @if ($data)
                                @foreach($data as $department)
                                    <tr>
                                        ...
                                        <td class="d-flex">
                                            <a href="{{ route('departments.show', $department->id) }}" class="btn btn-info btn-sm"><i class="fa fa-eye"></i></a>
                                            <a class="btn btn-sm btn-info" href="{{ route('departments.edit', $department->id) }}"><i class="fa fa-edit"></i></a>
